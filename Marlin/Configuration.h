...
#define Z_PROBE_FEEDRATE_FAST (37*60)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_BED_SIZE /4)   // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (Y_BED_SIZE /4)  // (mm) Y point for Z homing
