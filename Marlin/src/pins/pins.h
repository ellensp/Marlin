...
#elif MB(STM32F103RE)
  #include "stm32f1/pins_STM32F1R.h"            // STM32F103RE                            env:STM32F103RE env:STM32F103RE_stm32
#elif MB(MALYAN_M200)
  #include "stm32f1/pins_MALYAN_M200.h"         // STM32F103CB                            env:STM32F103CB_malyan
#elif MB(STM3R_MINI)
  #include "stm32f1/pins_STM3R_MINI.h"          // STM32F103RE?                           env:STM32F103RE env:STM32F103RE_stm32
#elif MB(GTM32_PRO_VB)
  #include "stm32f1/pins_GTM32_PRO_VB.h"        // STM32F103VE                            env:STM32F103RE env:STM32F103VE_stm32
#elif MB(GTM32_PRO_VD)
  #include "stm32f1/pins_GTM32_PRO_VD.h"        // STM32F103VE                            env:STM32F103RE env:STM32F103VE_stm32
#elif MB(GTM32_MINI)
  #include "stm32f1/pins_GTM32_MINI.h"          // STM32F103VE                            env:STM32F103RE env:STM32F103VE_stm32
#elif MB(GTM32_MINI_A30)
  #include "stm32f1/pins_GTM32_MINI_A30.h"      // STM32F103VE                            env:STM32F103RE env:STM32F103VE_stm32
#elif MB(GTM32_REV_B)
  #include "stm32f1/pins_GTM32_REV_B.h"         // STM32F103VE                            env:STM32F103RE env:STM32F103VE_stm32
#elif MB(MORPHEUS)
  #include "stm32f1/pins_MORPHEUS.h"            // STM32F103RE                            env:STM32F103RE env:STM32F103RE_stm32
#elif MB(CHITU3D)
  #include "stm32f1/pins_CHITU3D.h"             // STM32F103ZE                            env:STM32F103RE env:STM32F103ZE_stm32
#elif MB(MKS_ROBIN)
...
#elif MB(BEAST)
  #include "stm32f1/pins_BEAST.h"               // STM32F103VE?                           env:STM32F103RE env:STM32F103VE_stm32
